...
function OrionLib:MakeWindow(WindowConfig)
	...
	ColorSequenceKeypoint.new(0.45, Color3.fromRGB(75, 0, 130)),      -- Темно-фиолетовый
	ColorSequenceKeypoint.new(0.67, Color3.fromRGB(20, 20, 20)),       -- Снова темный (плавно замыкает круг)
	ColorSequenceKeypoint.new(0.75, Color3.fromRGB(75, 0, 130)),      -- Темно-фиолетовый (Indigo)
	ColorSequenceKeypoint.new(0.90, Color3.fromRGB(138, 43, 226)),    -- Яркий фиолетовый (пик свечения)
